...
Для роутеров с 16 МБ flash приоритетные туннели — WireGuard и AmneziaWG. Новые установки RouteWolf автоматически ставят безопасный MTU `1280` для `wg0`/`awg0`, а AmneziaWG дополнительно читает `MTU` из полного клиентского конфига, если он там указан.

После обновления существующего роутера можно принудительно применить MTU:
...
Если нужен другой MTU, его можно задать перед установкой или обновлением:
